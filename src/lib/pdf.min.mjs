...
class BaseCanvasFactory {
  ...
  create(t, e) {
    ...
    return {
      canvas: i,
      context: i.getContext("2d", { willReadFrequently: !this.#i }),
    };
  }
  reset(t, e, i) {
...
class DOMCMapReaderFactory extends BaseCMapReaderFactory {
  _fetchData(t, e) {
    return fetchData(t, this.isCompressed ? "arraybuffer" : "text").then(
      (t) => ({
        cMapData:
          t instanceof ArrayBuffer ? new Uint8Array(t) : stringToBytes(t),
        compressionType: e,
      })
    );
  }
...
class AltText {
  ...
  async render() {
    ...
    if (this.#Gt) {
      ...
      e = await AltText._l10nPromise.get("pdfjs-editor-alt-text-button-label");
    t.textContent = e;
...
class AnnotationEditor {
  ...
  static initialize(t, e, i) {
    ...
    if (i?.strings)
      for (const e of i.strings) AnnotationEditor._l10nPromise.set(e, t.get(e));
  ...
  focusin(t) {
    this._focusEventsAllowed &&
      (this.#ie ? (this.#ie = !1) : this.parent.setSelected(this));
  }
  focusout(t) {
...
class MurmurHash3_64 {
  ...
  hexdigest() {
    ...
    e =
      ((4283543511 * e) & mt) |
      (((2950163797 * ((e << 16) | (t >>> 16))) & mt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & mt) | ((60499 * t) & ft);
    e =
      ((3301882366 * e) & mt) |
      (((3120437893 * ((e << 16) | (t >>> 16))) & mt) >>> 16);
    t ^= e >>> 1;
    return (
    ...
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage(
            { sourceName: i, targetName: s, stream: Lt, streamId: e, chunk: t },
            r
          );
        },
        close() {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      for (const i of t.groups)
        this.#Xe.set(i.id, new OptionalContentGroup(e, i));
      if ("OFF" === t.baseState)
        for (const t of this.#Xe.values()) t._setVisible(zt, !1);
...
class PDFWorker {
  ...
  static {
    ...
    this._createCDNWrapper = (t) => {
      const e = `await import(/* @vite-ignore */"${t}");`;
  ...
  static get _setupFakeWorkerGlobal() {
    return shadow(
      ...
      (async () => {
        ...
        return (await import(/* @vite-ignore */ this.workerSrc))
...
class WorkerTransport {
  ...
  getOptionalContentConfig(t) {
    return this.#rs("GetOptionalContentConfig").then(
...
class PopupElement {
  ...
  render() {
    ...
    if (this.#ks) {
      ...
      t.setAttribute(
        "data-l10n-args",
        JSON.stringify({ dateObj: this.#ks.valueOf() })
      );
      e.append(t);
    }
    const s = this.#Hs;
...
class FreeOutliner {
  ...
  toSVGPath() {
    ...
    if (isNaN(this.#Mn[6]) && !this.isEmpty())
      return `M${(this.#Mn[2] - n) / r} ${(this.#Mn[3] - a) / o} L${
        (this.#Mn[4] - n) / r
      } ${(this.#Mn[5] - a) / o} L${l} ${h} L${d} ${c} L${
        (this.#Mn[16] - n) / r
      } ${(this.#Mn[17] - a) / o} L${(this.#Mn[14] - n) / r} ${
        (this.#Mn[15] - a) / o
      } Z`;
    const u = [];
    u.push(`M${t[4]} ${t[5]}`);
    ...
    u.push(
      `L${(i[0] - n) / r} ${(i[1] - a) / o} L${l} ${h} L${d} ${c} L${
        (s[0] - n) / r
      } ${(s[1] - a) / o}`
    );
  ...
  toSVGPath() {
    ...
    for (let e = 6, i = this.#Un.length; e < i; e += 6)
      isNaN(this.#Un[e])
        ...
        : t.push(
            `C${this.#Un[e]} ${this.#Un[e + 1]} ${this.#Un[e + 2]} ${
              this.#Un[e + 3]
            } ${this.#Un[e + 4]} ${this.#Un[e + 5]}`
          );
    t.push("Z");
    return t.join(" ");
  }
...
class ColorPicker {
  ...
  #sa(t, e) {
    e.stopPropagation();
    this.#Jn.dispatch("switchannotationeditorparams", {
      source: this,
      type: this.#Zn,
      value: t,
    });
  ...
  #ea(t) {
    ...
    this.#Yn = 0 === t.detail;
    window.addEventListener("pointerdown", this.#$n, {
      signal: this.#m._signal,
    });
    if (this.#Kn) {
  ...
  updateColor(t) {
    ...
    for (const i of this.#Kn.children)
...
class HighlightEditor extends AnnotationEditor {
  ...
  #ya({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    ...
    if (e >= 0) {
      ...
      this.parent.drawLayer.updateBox(
        this.#ba,
        HighlightEditor.#_a(this.#ha.box, e)
      );
    }
  ...
  static async deserialize(t, e, i) {
    ...
    if (a) {
      ...
      const { id: n, clipPathId: a } = e.drawLayer.highlight(
        s,
        l.color,
        l._defaultOpacity,
        !0
...
class StampEditor extends AnnotationEditor {
  ...
  static async deserialize(t, e, i) {
    ...
    if (t instanceof StampAnnotationElement) {
      ...
      c.remove();
      const p =
        (await e._structTree.getAriaAttributes(`${it}${r}`))?.get(
          "aria-label"
        ) || "";
      s = t = {
...
class AnnotationEditorLayer {
  ...
  enableTextSelection() {
    ...
    if (this.#Gr?.div && !this.#$r) {
      ...
      this.#Gr.div.addEventListener("pointerdown", this.#qr.bind(this), {
        signal: t,
      });
  ...
  moveEditorInDOM(t) {
    ...
    t._structTreeParentId = this.#Qs?.moveElementInDOM(
      this.div,
      t.div,
      t.contentDiv,
      !0
